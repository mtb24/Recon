...
if (!empty($_GET['view_id'])) { 
	...
	// for compatability with old system, if employee_name is a number, lookup employee name from employees table
//	if (is_numeric ($header['employee_name'])) {
//		$query   = "select firstname, lastname from employees where id = ".$header['employee_name'];
//		$result  = mysql_query($query) or die(mysql_error());
//		$result  = mysql_fetch_assoc($result);
//		$real_username = "'".$result['firstname']." ".$result['lastname']."'";
//		$items['user']	 =   $real_username;
//	}
//	else {
