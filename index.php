    ...
    <body>
	    ...
	    <div id="form" style="display:none;">
			...
			<div id="service">
				...
				<label for="headcount">Head count </label><input type="number" size="7" name="headcount" id="service_head_count" value="" />
			...
			<input id="header_id" name="header_id" type="hidden" value="" />
