$(document).ready(function() {
        ...
        $(document).on("click", ".submit", function(e) {
            ...
            //if ( inputsValid() ) { 
                ...
                .done(function(response) {
                    ...
                    $('.submit').attr("disabled","true").addClass("input-valid").val("Done!");
                });
                //return false;
            //} else {
     ...
     */
        ...
        $(document).on("change", "#service_labor_completed", function() {
            ...
            } else if (serviceVariance > 0 || serviceVariance === 0) {
                $("#service_labor_completed").removeClass("input-error");
            }
        });
        ...
        function setLaborGoal() {
            var store = $('#store_id option:selected').val(),
                headcount = $("#service_head_count").val(),
                laborgoal = ( labor_goal[store] * headcount );
            document.getElementById("service_labor_goal").value = laborgoal;
        }
